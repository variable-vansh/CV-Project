...
function App() {
  ...
  return (
    <>
    <GeneralSwitch btnClicked={btnClicked} changeBtnClick={changeBtnClick} class={'test'}/>
    <EducationSwitch eduBtnClicked={eduBtnClicked} eduChangeBtnClick={eduChangeBtnClick}/>
    <ExperienceSwitch expBtnClicked={expBtnClicked} expChangeBtnClick={expChangeBtnClick}/>
    </>
  )
}
